...
Recall that the USArrests dataset contains statistics on crime in the United States. Specifically, it includes data on the arrest rates for different types of crime in each of the 50 states in the US.

The dataset includes the following columns:

- Murder: The murder arrest rate (per 100,000 residents) in each state.
- Assault: The assault arrest rate (per 100,000 residents) in each state.
- UrbanPop: The percentage of the population living in urban areas in each state.
- Rape: The rape arrest rate (per 100,000 residents) in each state.
...
2. Visualise the $K$-means result and compare with HAC result obtained in Lab 6.  
...
*Reminder: The silhouette width and plot were introduced in Week 6.*
